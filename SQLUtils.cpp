...
namespace
{
     ...
     */
    int executeSqlQuery(const std::string& query, const std::string& databasePath, const std::vector<std::string>& listOfElements)
    {
...
namespace SQLUtils
{
    ...
    bool addUserToTable(const std::string& username, const std::string& password, const std::string& databasePath)
    {
        auto result = executeSqlQuery("INSERT INTO users (username, password) VALUES (?, ?);", databasePath, {username, password});
